...
export abstract class TodosServices{

    static async AddTodo(apiEndPoint: string, data: {todoText: string, isDone: boolean}, jwt: string | null ){
    ...
    static async GetTodos(apiEndPoint: string, jwt: string | null){
        try {

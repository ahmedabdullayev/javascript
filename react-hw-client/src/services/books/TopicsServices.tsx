...
export abstract class TopicsServices{

    static async AddTopic(apiEndPoint: string, data: {name: string, description: string}, jwt: string | null ){
    ...
    static async GetTopics(apiEndPoint: string, jwt: string | null){
        try {
